        ...
        >
            {
                snippets.map((snippet, index) => {
                    return (
                        <div
                            key={index}
                            className={`absolute left-0 w-full px-4 pt-4 bg-background-fill transition-all duration-700 ease-out origin-center rounded-xl overflow-y-auto cursor-pointer snippet-scrollbar`}
                            style={{
                                // width: "500px",
                                height: ITEM_HEIGHT,
