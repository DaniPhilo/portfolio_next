...
export default async function Home() {
  ...
  return (
    <div className='relative h-full flex justify-center items-center gap-6 2xl:gap-16 p-4 lg:p-6'>
      <Hero />
      {/* <SnakeGame /> */}
      <div className='absolute top:0 left:0 lg:relative w-full h-full lg:max-w-[600px] 2xl:max-w-[700px]'>
